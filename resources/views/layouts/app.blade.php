...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/mention.js/1.4.5/mention.min.css">
<script src="https://cdnjs.cloudflare.com/ajax/libs/mention.js/1.4.5/mention.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>

<!-- Include jQuery Atwho -->
<link rel="stylesheet" href="{{asset('assets/dist/css/jquery.atwho.min.css')}}">
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <script src="{{asset('assets/dist/js/jquery.atwho.min.js')}}"></script>
